      ...
      <div className={dashboardStyles.filterBar}>
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 sm:pb-0 no-scrollbar">
          <div className={dashboardStyles.toggleGroup}>
            <div
              className={`${dashboardStyles.tabButton} ${dashboardStyles.tabButtonActive} opacity-50`}
            >
              Active
            </div>
            <div
              className={`${dashboardStyles.tabButton} ${dashboardStyles.tabButtonInactive} opacity-30`}
            >
              History
            </div>
          </div>
