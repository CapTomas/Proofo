            ...
            <Card className="overflow-hidden border shadow-card bg-card w-full">
              ...
              <div className="bg-muted/50 dark:bg-muted/30 border-b py-4 px-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg leading-tight">Freelance Design Contract</CardTitle>
              ...
              <CardContent className="p-5 space-y-3 bg-card">
                ...
                <div className="space-y-0.5">
                  <h4 className="text-xs font-medium text-muted-foreground mb-2 uppercase tracking-wider">Terms</h4>
                  ...
                  {step === "signing" && (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant="ghost" size="sm" onClick={handleReset} className="h-7 text-xs px-2">Cancel</Button>
                      </div>
                    ...
                    >
                      <div className="flex flex-col items-center justify-center gap-5">
                        ...
                        <div className="space-y-2 w-full max-w-xs mx-auto">
                          ...
                          <p className="text-xs text-muted-foreground">Creating immutable proof...</p>
                        </div>
                      </div>
                    </motion.div>
                  )}
                  ...
                  {step === "sealed" && (
                    ...
                    >
                      <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-3 flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-sm text-emerald-900 dark:text-emerald-100">Deal Sealed</h3>
                      ...
                      <div className="grid sm:grid-cols-2 gap-3">
                        <div className="border rounded-xl p-3 bg-background/50">
                          <div className="text-[10px] text-muted-foreground uppercase tracking-wider font-medium mb-1">Signature</div>
                          {signature && (
                            <img src={signature} alt="Signature" className="h-10 object-contain opacity-90 dark:invert" />
                          )}
                        </div>
                        <div className="border rounded-xl p-3 bg-background/50 flex flex-col justify-center">
                          <div className="text-[10px] text-muted-foreground uppercase tracking-wider font-medium mb-1">Digital Seal</div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 pt-1">
                        <Button className="flex-1 gap-2 h-10 text-xs rounded-xl" variant="outline" onClick={handleReset}>
