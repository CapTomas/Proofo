    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Link href="/" className="flex items-center justify-center gap-2.5 mb-8">
          <svg viewBox="0 0 5765 5765" xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 text-foreground" style={{ display: 'block', transform: 'scaleY(-1)' }}>
        ...
        <Card className="shadow-2xl shadow-black/5 border-border/50">
          <CardHeader className="text-center pb-2">
            {/* Back to Home link - positioned at top of card */}
            <Link href="/" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors mb-4 justify-center group">
