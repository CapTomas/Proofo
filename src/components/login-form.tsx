...
export function LoginForm({
    ...
    try {
      ...
      if (existingUser) {
        if (onSuccess) onSuccess();
          ...
          const finalRedirect = redirectTo || searchParams.get("redirect") || "/dashboard";
  ...
  return (
    <div className={className}>
      ...
      <Card className="shadow-2xl shadow-black/5 border-border/50 bg-card/50 backdrop-blur-xl">
